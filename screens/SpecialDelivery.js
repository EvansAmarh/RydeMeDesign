...
const HomeScreen = () => {
  ...
  const [markers, setMarkers] = useState([
    { id: 1, distance: 3, image: require('../assets/vehicle.png'), title: 'Driver Eugene' },
    { id: 2, distance: 20, image: require('../assets/vehicle2.png'), title: 'Driver Kwame' },
    { id: 3, distance: 1, image: require('../assets/vehicle3.png'), title: 'Driver Agya' },
  ]);
  ...
  const handleSearchChange = (query) => {
    ...
    if (query.length > 2) {
      navigation.navigate('SearchResultsSpecial', { query });
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal
        ...
        onRequestClose={() => {
          setSelectionModalVisible(!selectionModalVisible);
        }}
      >
        <View style={styles.modalView}>
          <Text style={styles.modalText}>Choose an option for {selectedMarker?.title}</Text>
          <Pressable
            style={styles.optionButton}
            onPress={() => handleSelection('ride')}
          >
            <Text style={styles.optionButtonText}>Ride</Text>
          </Pressable>
          <Pressable
            style={styles.optionButton}
            onPress={() => handleSelection('specialDelivery')}
          >
            <Text style={styles.optionButtonText}>Special Delivery</Text>
          </Pressable>
        </View>
      </Modal>
    </View>
